...
<div id="team-carousel" style="position: relative; width: 100%; margin-bottom: 2rem; overflow: hidden; border-radius: 8px;">
  <div class="carousel-track" style="display: flex; transition: transform 0.8s ease-in-out;">
    <img src="{{ '/assets/images/lab1.png' | relative_url }}" alt="Perdijk Lab Team Photo" style="width: 100%; flex-shrink: 0; height: auto; display: block;">
    <img src="{{ '/assets/images/lab2.png' | relative_url }}" alt="Perdijk Lab Team Photo May 2026" style="width: 100%; flex-shrink: 0; height: auto; display: block;">
  </div>
...
<div class="member-card" style="display: flex; gap: 1.5rem; margin-bottom: 2rem; align-items: flex-start;">
  <div class="member-photo" style="flex-shrink: 0;">
    {% if person.photo and person.gdpr_consent %}
      <img src="{{ '/assets/images/' | append: person.photo | relative_url }}" alt="{{ person.name }}" style="width: 150px; height: 150px; object-fit: cover; border-radius: 8px; background-color: #f1f5f9;">
    {% else %}
